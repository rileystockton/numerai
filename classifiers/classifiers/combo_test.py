...
def main():
    ...
    # features = reduced_features
    # features = ['feature4', 'feature9', 'feature20', 'feature56', 'feature59', 'feature70', 'feature75', 'feature83', 'feature96', 'feature111', 'feature113', 'feature116', 'feature117', 'feature124', 'feature125', 'feature126', 'feature145', 'feature183', 'feature185', 'feature192', 'feature193', 'feature200', 'feature202', 'feature204', 'feature233', 'feature235', 'feature236', 'feature247', 'feature249', 'feature251']
    result_file = '../combo_test_addition.txt'
    for cmb in [('feature1','feature16'),('feature4','feature21'),('feature5','feature17'),('feature10','feature19'),('feature16','feature18'),('feature16','feature20')]:
        for i in range(3):
            new_features = list(features)
            new_training_data = pd.DataFrame(training_data)
            new_validation_data = pd.DataFrame(validation_data)
            new_test_data = pd.DataFrame(test_data)
            new_tournament_data = pd.DataFrame(tournament_data)
            new_feature_name = "_-_".join(cmb)
            new_training_data[new_feature_name] = training_data[cmb[0]] - training_data[cmb[1]]
            new_validation_data[new_feature_name] = validation_data[cmb[0]] - validation_data[cmb[1]]
            new_test_data[new_feature_name] = test_data[cmb[0]] - test_data[cmb[1]]
            new_tournament_data[new_feature_name] = tournament_data[cmb[0]] - tournament_data[cmb[1]]
            # new_features.remove(cmb[0])
            # new_features.remove(cmb[1])
            ...
            # )
            #
            # model = EnsembleVoteClassifier(clfs=[model_1, model_2, model_3, model_4, model_5, model_6, model_7, model_8], voting='soft', weights=[7,2,0,0,2,1,2,1])
