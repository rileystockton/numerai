...
def main():
    ...
    np.random.seed(seed)
    final = sys.argv[1]
    hidden_layer_arg = int(sys.argv[2])
    ...
    model = Pipeline([
        ...
        ('mlp', MLPClassifier(hidden_layer_sizes=(hidden_layer_arg,), solver='lbfgs', alpha=alpha_arg))
    ])
    ...
    joined.to_csv("../predictions/{}_{}_{}_validation{}.csv".format(script_name, hidden_layer_arg, alpha_arg, final_string), index=False)
    ...
    joined.to_csv("../predictions/{}_{}_{}{}.csv".format(script_name, hidden_layer_arg, alpha_arg, final_string), index=False)
