...
def main():
    ...
    model_2 = Pipeline([
        ('scaler', StandardScaler()),
        ('mlp', MLPClassifier(hidden_layer_sizes=(3,), solver='lbfgs', alpha=0.00001))
    ])

    model_3 = Pipeline([
        ('scaler', StandardScaler()),
        ('mlp', MLPClassifier(hidden_layer_sizes=(10,), solver='lbfgs', alpha=0.001))
    ])

    model_4 = Pipeline([
        ('scaler', StandardScaler()),
        ('mlp', MLPClassifier(hidden_layer_sizes=(10,), solver='lbfgs', alpha=0.00001))
    ])
